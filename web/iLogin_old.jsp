                ...
                <div class="box">
                    ...
                    <form onsubmit="return false">
                        <div class="content no-padding">
                            ...
                            <div class="section _100" style="display: none" id="divapsodusertype">
                                <label style=" margin-top: 3px">
                                    User Type
                                </label>
                                <div>
                                    <select id="apsOdUserType">
...
<script>
    localStorage.clear();
    sessionStorage.loginpage="iLogin.jsp";
...
<!-- Start Show Hide User Type Div-->
<script>
    var exapsodusername=0;
    var exapsodpassword=0;
    ...
    function checkextapsod(){
        if(exapsodusername==1 && exapsodpassword==1)
            {
                $("#divapsodusertype").show();
            }
            if(($("#username").val().length==0) && ($("#password").val().length==0))
                {
                    exapsodusername=0;
                    exapsodpassword=0;
                    $("#divapsodusertype").hide();   
                }
    }
    </script>
 <!-- End Show Hide User Type Div-->
...
<!--Start ApsOd Fields Authentication-->
 ...
 <!--End ApsOd Fields Authentication-->