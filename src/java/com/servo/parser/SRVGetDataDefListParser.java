...
public class SRVGetDataDefListParser extends DefaultHandler{
    ...
    private boolean datadefinition = false;
    
    /**--------------------------------------------------------------------------
     *    Function Name             : startElement
     *    Author                    : 
     *    Date written (DD/MM/YYYY) : 21st Sep 2013
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {        
       tagValue = new String();
       if (qName.equalsIgnoreCase("DataDefinition")) {
